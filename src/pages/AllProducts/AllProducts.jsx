...
export default function AllProducts() {
  ...
  const filterProducts = () => {
    ...
    if (selectedFilter.includes(priceFilter[1])) {
      let tempProduct = products.filter(product => product.price >= 2000000 && product.price <= 4000000)
      filteredProductsByPrice = [...filteredProductsByPrice, ...tempProduct]
      amountPrice++;
    }
    if (selectedFilter.includes(priceFilter[2])) {
      let tempProduct = products.filter(product => product.price >= 4000000 && product.price <= 7000000)
      filteredProductsByPrice = [...filteredProductsByPrice, ...tempProduct]
      amountPrice++;
    }
    if (selectedFilter.includes(priceFilter[3])) {
      let tempProduct = products.filter(product => product.price >= 7000000 && product.price <= 13000000)
      filteredProductsByPrice = [...filteredProductsByPrice, ...tempProduct]
      amountPrice++;
    }
    ...
    if (selectedFilter.includes(typeFilter[0])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[0]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++;
    }
    if (selectedFilter.includes(typeFilter[1])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[1]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++
    }
    if (selectedFilter.includes(typeFilter[2])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[2]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++
    }
    if (selectedFilter.includes(typeFilter[3])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[3]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++
    }
    if (selectedFilter.includes(typeFilter[4])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[4]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++
    }
    if (selectedFilter.includes(typeFilter[5])) {
      let tempProduct = products.filter(product => product.category.categoryDetail.includes(typeFilter[5]))
      filteredProductsByType = [...filteredProductsByType, ...tempProduct]
      amountType++
    }
    ...
    if (selectedFilter.includes(colorFilter[0])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[0].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[1])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[1].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[2])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[2].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[3])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[3].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[4])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[4].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[5])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[5].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[6])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[6].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    if (selectedFilter.includes(colorFilter[7])) {
      let tempProduct = products.filter(product => product.color.includes(colorFilter[7].toLowerCase()))
      filteredProductsByColor = [...filteredProductsByColor, ...tempProduct]
      amountColor++;
    }
    ...
    if (selectedFilter.includes(fabricTypeFilter[0])) {
      let tempProduct = products.filter(product => product.category.fabricType.includes(fabricTypeFilter[0]))
      filteredProductsByFabric = [...filteredProductsByFabric, ...tempProduct]
      amountFabric++;
    }
    if (selectedFilter.includes(fabricTypeFilter[1])) {
      let tempProduct = products.filter(product => product.category.fabricType.includes(fabricTypeFilter[1]))
      filteredProductsByFabric = [...filteredProductsByFabric, ...tempProduct]
      amountFabric++;
    }
    if (selectedFilter.includes(fabricTypeFilter[2])) {
      let tempProduct = products.filter(product => product.category.fabricType.includes(fabricTypeFilter[2]))
      filteredProductsByFabric = [...filteredProductsByFabric, ...tempProduct]
      amountFabric++;
    }
    if (selectedFilter.includes(fabricTypeFilter[3])) {
      let tempProduct = products.filter(product => product.category.fabricType.includes(fabricTypeFilter[3]))
      filteredProductsByFabric = [...filteredProductsByFabric, ...tempProduct]
      amountFabric++;
    }
    if (selectedFilter.includes(fabricTypeFilter[4])) {
      let tempProduct = products.filter(product => product.category.fabricType.includes(fabricTypeFilter[4]))
      filteredProductsByFabric = [...filteredProductsByFabric, ...tempProduct]
      amountFabric++;
    }
    ...
    if (amountFabric !== 0 && filteredProductsByFabric.length === 0 ||
    ...
    for (let i = 0; i < filterTemp.length - 1; i++) {
      for (let j = i + 1; j < filterTemp.length; j++) {
        if (filterTemp[i]._id === filterTemp[j]._id) {
          if (filterResult.length === filterTemp.length)
            filterResult = [];
      ...
      <div className={cx("main")}>
        ...
        <div className={cx("products")}>
          ...
          <div className={cx("productsContainer")}>
            {
              products ?
                selectedFilter.length > 0 ? filteredProducts.map((product, index) => (
                  <div className={cx("productCard")} key={index}>
                    <Product title={product.name} oldPrice={product.price} image={product.images[0].imgUrl} />
                  </div>
                )) :
