        ...
        <div className={cx("cart-popup-container")}>
          <div className={cx("cart-popup-header")}>
            <span>
              ...
              Nhập thông tin
              <IoClose className={cx("cart-popup-close-icon")} onClick={() => setHidePopup(true)} />
            </span>
          </div>
              ...
              <div className={cx("group-size")}>
                {
                  product.size.map(size => (
                    <div className={cx("size", selectedSize === size && "active-selected")} onClick={() => handleSelectSize(size)}>
                      {size}
                    </div>
                  ))
                }
              ...
              <div className={cx("group-color")}>
                {
                  product.color.map(color => (
                    <div className={cx("color", selectedColor === color && "active-selected")} onClick={() => handleSelectColor(color)}>
                      {color}
                    </div>
                  ))
                }
          ...
          <div className={cx("cart-popup-button-group")}>
            ...
            <button type="button" className={cx("btn-checkout")} onClick={handleAddToCart}>
              Thêm vào giỏ
            </button>
          </div>
        </div>
